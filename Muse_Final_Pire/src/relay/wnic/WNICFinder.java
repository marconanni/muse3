...
public class WNICFinder 
{
	 ...
	 * La classe dell'oggetto restituito sara' diversa a seconda del sistema operativo,
	...
	public static RelayWNICController getCurrentWNIC(String interf, String essidName, int previous) throws OSException, WNICException{
		...
		if(os.startsWith("Windows")){
			if((interf.compareTo(NetConfiguration.NAME_OF_AD_HOC_CLUSTER_HEAD_WIFI_INTERFACE)==0)||
			   (interf.compareTo(NetConfiguration.NAME_OF_AD_HOC_CLUSTER_WIFI_INTERFACE)==0))
