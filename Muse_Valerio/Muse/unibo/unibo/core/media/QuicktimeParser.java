...
// 			       " ==> " + time);
	...
	public void setMediaTime(Time time){
		...
		int frame=mapTimeToFrame(time);
		this.sampleIndex=frame;
		this.useSampleIndex=frame;
		System.out.println("Impostato time="+time.getNanoseconds());
	}
