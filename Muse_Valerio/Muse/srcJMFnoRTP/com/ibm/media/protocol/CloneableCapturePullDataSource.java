/*
 * @(#)CloneableCapturePullDataSource.java	1.2 02/08/21
 *
...
/**
 * This is a utility class for creating clones of PullDataSource. 
 * THe class reflects the functionality of a PullDataSource and provides
 ...
 * each time the PullDataSource's streams are read.
 * This class also implements the CaptureDevice interface.
 */
public class CloneableCapturePullDataSource extends PullDataSource 
