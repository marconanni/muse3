...
import muse.client.ClientMessageFactory;
...
public class ClientFrame extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				ClientFrame thisClass = new ClientFrame(null);
	...
	public ClientFrame(Activator act) {
		super();
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setText("Seleziona file");
