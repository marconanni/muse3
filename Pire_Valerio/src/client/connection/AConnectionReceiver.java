...
public class AConnectionReceiver extends Observable implements Runnable{
	 ...
	 * @param localhost l'indirizzo locale del nodo
	 * @param localInputPort la porta tramite cui ricevere i messaggi
	 */
	public AConnectionReceiver(Observer observer,InetAddress localhost, int localInputPort){
		
		if(localhost == null) throw new IllegalArgumentException(managerName+" : indirizzo passato al costruttore a null");
