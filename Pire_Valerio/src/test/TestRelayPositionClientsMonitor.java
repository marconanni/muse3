...
class TestRelayPositionMonitor{
	...
	public static void main(String args[]) throws UnknownHostException{
		...
		RelayPositionMonitor rpcm = new RelayPositionMonitor(50,1000,to, new DebugConsole("TEST"));
		rpcm.start();
		...
		try {
			...
			DatagramPacket dp = RelayMessageFactory.buildNotifyRSSI(0, 120, localhost, PortConfiguration.RSSI_PORT_IN, MessageCodeConfiguration.TYPECLIENT,1);
			Thread.sleep(4000);
			ds.send(dp);
			ds.close();
