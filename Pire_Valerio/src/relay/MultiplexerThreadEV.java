...
import unibo.core.thread.iMultiplexerSupendedListener;

import com.sun.media.ExtBuffer;

/**
 * <p>Thread che incapsula un componente conforme all'interfaccia Multiplex, definita nel package unibo.core.multiplexer.</p>
...
* <p>In particolare il buffer utilizzato � un EventCircularBuffer.<p/>
* 
 * @author Carlo Di Fulco
 *
 */
public class MultiplexerThreadEV {
	...
	protected EventCircularBuffer buffer;
...
//metodo costruttore che inizializza la classe thread col multiplexer, l'array di CirclarBuffer e il parametro id
	public MultiplexerThreadEV(Multiplex multiplexer, EventCircularBuffer buffer, iMultiplexerSupendedListener muxSusp, long id) throws IOException
	{
		this.id=id;
...
//metodo costruttore analogo al precedente con la differenza che imposta come debug messanger quello passato dal proprietario dell'oggetto
	public MultiplexerThreadEV(iDebugWriter debugger, Multiplex multiplexer, EventCircularBuffer buffer, iMultiplexerSupendedListener muxSusp, long id) throws IOException
	{
		this.id=id;
...
//metodo costruttore che inizializza la classe thread col multiplexer, l'array di CirclarBuffer e il parametro address del client
	public MultiplexerThreadEV(Multiplex multiplexer, EventCircularBuffer buffer, iMultiplexerSupendedListener muxSusp, String address) throws IOException
	{
...
//metodo che si occupa di effettuare gli assegnamenti sempre presenti nelle diverse tipologie di metodi costruttori
	private void constructorAssigment(iDebugWriter debugger, Multiplex multiplexer, EventCircularBuffer buffer, iMultiplexerSupendedListener muxSusp)
	{
		close=false;
		closed=false;
