...
public class MultiplexerThreadPS
{
	...
	/**
	 * @return the pauseMultiplexing
	 */
	public boolean isPauseMultiplexing() {
		return pauseMultiplexing;
	}
...
/***************************************************************************/
	...
	//		System.err.println("MULTIPLEXER PRESO FRAME "+frame.getSequenceNumber()/*);+" duration "+frame.getDuration()+" length "+frame.getLength()+"\nseqnumb "+frame.getSequenceNumber()+" EOM "+frame.isEOM()+"\ntimestamp "+frame.getTimeStamp()*/);
/***************************************************************************/
