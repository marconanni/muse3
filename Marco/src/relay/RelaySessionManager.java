		...
		if(arg instanceof String)
		{
				 ...
				 */
			{
				...
				if(this.connectedClusterHeadAddress.equals(vecchioRelay)){
					// posso gi� permettermi di sostituire il riferimento al big boss perch� 
					// so che ci pu� essere una sola rielezione in corso alla volta, si interagirebbe con il 
