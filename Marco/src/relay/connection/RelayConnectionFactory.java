...
//}
	...
	public static RelayCM getSessionConnectionManager(Observer obser){
		return new RelayCM("SessionCM ",rpm.getLocalClusterAddress(),rpm.getLocalClusterBCASTAddress(),rpm.getPortInClusterSession(),rpm.getPortOutClusterSession(),obser,false);
		}
}