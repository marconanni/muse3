...
public class PConnectionManager extends AConnectionManager  {
	 ...
	 */
	public PConnectionManager(boolean cR, InetAddress localAdHocAddress, int localAdHocInputPort, int localAdHocOutputPort, InetAddress localManagedAddress,  int localManagedInputOutputPort, Observer observer){
		
		super( localAdHocAddress,null,localAdHocInputPort,localAdHocOutputPort, observer,false);
