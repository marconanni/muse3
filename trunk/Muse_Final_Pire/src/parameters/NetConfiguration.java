...
public class NetConfiguration {
	...
	public static final String SERVER_ADDRESS = "192.168.187.8";
	...
	public static final String RELAY_AD_HOC_CLUSTER_ADDRESS = "192.168.1.2";					//non server al bigboss

	/** indirizzo IP del RELAY nella rete Ad-Hoc di competenza del BigBoss (cluster head)*/
	public static final String RELAY_AD_HOC_CLUSTER_HEAD_ADDRESS = "192.168.1.2";
	
	/** indirizzo IP del RELAY sulla rete Managed (BigBoss) */
	public static final String RELAY_MANAGED_ADDRESS = "192.168.187.8";							//non server al relay attivo
	
	/** indirizzo IP di BROADCAST sulla rete Ad-Hoc (cluster) */
	public static final String CLUSTER_BROADCAST_ADDRESS = "192.168.1.255"; 
	
	/** indirizzo IP di BROADCAST sulla rete Ad-Hoc (cluster head) */
	public static final String CLUSTER_HEAD_BROADCAST_ADDRESS = "192.168.1.255"; 
	
	/** Nome della rete Ad-Hoc (cluster) */
	public static final String NAME_OF_AD_HOC_CLUSTER_NETWORK = "pire";
	...
	public static final String NAME_OF_AD_HOC_CLUSTER_WIFI_INTERFACE = "wlan0";
	
	/** Nome dell'interfaccia con cui il Relay si affaccia sulla rete Ad-Hoc (cluster head)*/
	public static final String NAME_OF_AD_HOC_CLUSTER_HEAD_WIFI_INTERFACE = "wlan0";
	
	/**Nome dell'interfaccia con cui il Relay si affaccia sulla rete Managed*/
	public static final String NAME_OF_MANAGED_WIFI_INTERFACE  = "wlan1";						//serve solo al bigboss
