    ...
    implements SessionManager
{
        ...
        throws IOException, InvalidSessionAddressException
    {
        ...
        try
        {
            ...
            {
                mine = InetAddress.getByName("localhost");
            }
        }
        catch(Throwable e)
        {
        ...
        throws InvalidSessionAddressException
    {
        ...
        System.out.println("Local address: "+localAddresses[0]);
        ...
        throws InvalidSessionAddressException
    {
        ...
        } else
        {
            ...
            for(int k = 0;k < addrlist.length;k++){
            	System.out.println("Address "+addrlist[k]);
            }
            for(int i = 0; i < addrlist.length && (!dataOk || !ctrlOk); i++)
            {
                if(addrlist[i].equals(localAddress.getDataAddress())){
                	System.out.println("Address "+addrlist[i]+" local address "+localAddress.getDataAddress());
                	dataOk = true;
                }
                if(addrlist[i].equals(localAddress.getControlAddress())){
                	System.out.println("Address "+addrlist[i]+" local address "+localAddress.getControlAddress());
                	ctrlOk = true;
                }
            }
