...
public class G729Parser extends BasicPullParser {
    ...
    private static ContentDescriptor[] supportedFormat = new ContentDescriptor[] {new ContentDescriptor("audio.g729"), new ContentDescriptor("audio.g729a")};
...
// 	    newPos = maxLocation;
	...
	G729Track(AudioFormat format, boolean enabled, Time startTime,
	       int numBuffers, int bufferSize,
	       long minLocation, long maxLocation) {
	    super(G729Parser.this, 
		  format, enabled, G729Parser.this.duration,
		  startTime, numBuffers, bufferSize,
		  G729Parser.this.stream, minLocation, maxLocation);
