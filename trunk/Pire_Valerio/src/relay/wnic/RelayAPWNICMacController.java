...
public class RelayAPWNICMacController implements RelayWNICController {
	 ...
	 * @throws InvalidAccessPoint
	 */
	public AccessPointData getAssociatedAccessPoint() throws WNICException {return currentAP;}
	public void setNewCurrentAP(AccessPointData ap) {this.currentAP = ap;}
	 ...
	 * @throws WNICException
	 */
	public boolean isConnected() throws WNICException {return isAssociated && isOn && essidFound;}
	...
	public boolean isModeManaged() throws WNICException {return modeManaged;}
