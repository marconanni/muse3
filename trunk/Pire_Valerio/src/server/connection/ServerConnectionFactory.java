...
public class ServerConnectionFactory {
	...
	public static ServerCM getSessionConnectionManager(Observer obser){
		System.out.println("ServerConnectionFactory: getSessionConnectionManager -> spm.getLocalHostAddress().getHostAddress()="+spm.getLocalHostAddress().getHostAddress());
		return new ServerCM(spm.getLocalHostAddress().getHostAddress(),PortConfiguration.SERVER_SESSION_PORT_IN,obser);
	}
	...
	public static StreamingServerCM getStreamingServerConnectionManager(Observer obser){
		System.out.println("ServerConnectionFactory: getStreamingServerConnectionManager ->  spm.getLocalHostAddress()="+spm.getLocalHostAddress());
