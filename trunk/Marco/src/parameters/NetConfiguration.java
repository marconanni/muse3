...
public class NetConfiguration {
	...
	public static final String RELAY_CLUSTER_ADDRESS = "192.168.70.81";		//indirizzo IP del RELAY nella rete Ad-Hoc di sua competenza (cluster) non server al bigboss
	public static final String RELAY_CLUSTER_BROADCAST_ADDRESS = "192.168.70.81"; 		//indirizzo IP di BROADCAST sulla rete Ad-Hoc (cluster)
	...
	public static final String CLIENT_ADDRESS = "192.168.70.81";;						//indirizzo IP del CLIENT
	public static final String CLIENT_BROADCAST_ADDRESS = "192.168.70.81";
