...
/**
 * @author Carlo Di Fulco modificato da Dejaco Pire
 *
 */
public class ClientMessageReader {
	 ...
	 * */
	 private void readMessage(){
		...
		if (code == Parameters.ELECTION_BEACON)relayAddressBacon = st.nextToken();
		if (code == Parameters.ELECTION_RELAY_DONE)newRelayAddress = st.nextToken();
		if (code == Parameters.ELECTION_BIGBOSS_DONE)newRelayAddress = st.nextToken();
	}
