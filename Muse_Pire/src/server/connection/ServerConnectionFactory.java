...
public class ServerConnectionFactory {
	 ...
	 */
	public static ServerCM getSessionConnectionManager(Observer obser, DebugConsole console){
		return new ServerCM(spm.getLocalHostAddress().getHostAddress(),Parameters.SERVER_SESSION_PORT_IN,obser,console);
	}
