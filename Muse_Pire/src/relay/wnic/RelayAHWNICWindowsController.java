...
public class RelayAHWNICWindowsController implements RelayWNICController {
	...
	public RelayAHWNICWindowsController(String interf,String essidName) throws WNICException{
		this.interf = interf;
		this.essidName = essidName;
		
		console.debugMessage(Parameters.DEBUG_INFO, "ClientWNICMacOsController: Controllo l'esistenza e lo stato dell'interfaccia"+interf);
	}
	...
	public void setRelayAddress(String rA) throws WNICException {
		relayAddress = rA;
		console.debugMessage(Parameters.DEBUG_INFO, "ClientWNICWindowsController.setRelayAddress(): mi metto ad osservare l'indirizzo IP " + relayAddress);
	}
